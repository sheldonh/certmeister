...
require 'certmeister/signing_response'

describe Certmeister::SigningResponse do
  ...
  describe "on error" do
    ...
    it "is not signed" do
      response = Certmeister::SigningResponse.new(nil, "something went wrong")
    ...
    it "doesn't provide the PEM-encoded X509 certificate as a string" do
      response = Certmeister::SigningResponse.new(pem, "something went wrong")
  ...
  describe "on success" do
    ...
    it "is signed" do
      response = Certmeister::SigningResponse.new(pem, nil)
